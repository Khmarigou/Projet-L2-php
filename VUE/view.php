            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link nav-link-1" aria-current="page" href=".?page=suggestion">Explorer</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    ...
                    <p>DVD Share est une plateforme en ligne de location de DVD entre particulier. Les locations sont basé sur un système de point qui donne la priorité au utilisateurs les plus engagés.</p>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
                    <h3 class="tm-text-primary mb-4 tm-footer-title">Liens utiles</h3>
                    <ul class="tm-footer-links pl-0">
                        <li><a href=".?page=suggestion">Explorer</a></li>
                        <li><a href=".?page=louer">Louer</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
